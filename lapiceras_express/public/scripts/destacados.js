fetch(`http://localhost:3000/api_products/destacados`)
...
.then(function (json) {
    ...
    if(arrayProd.length<1){
        containerSeleccionados.innerHTML=`<p> No tenemos productos seleccionados </p>`
    } else {
        ...
        //if después del for hay 3 o menos, insertar un solo carousel  con active;
            ...
            carouselDestacados.appendChild(carousel1)
            ...
            carouselDestacados.appendChild(carousel1b)
